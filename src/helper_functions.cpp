...
// rotate a vector
Eigen::Vector2f rotatevec(Eigen::Vector2f v, Eigen::Vector4f q)
{
	Eigen::Vector4f rotatedvec = getqMat(getqMat(q)*Eigen::Vector4f(0.0,v(0),v(1),0.0))*getqInv(q);
	return rotatedvec.segment(1,2);
}
